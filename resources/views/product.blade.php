            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="border-radius border mb-3 p-3 bg-white text-left mx-auto">
                    <div class="row gx-4 gx-lg-5 align-items-center">
                        <div class="col-lg-6 col-12"><img class="card-img-top mb-5 mb-md-0" src="{{$product->photo ? asset('img/products/'.$product->photo->file) : 'https://via.placeholder.com/450x700'}}" alt="{{$product->title}}" width="450" height="750"></div>
